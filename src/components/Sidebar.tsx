...
function Sidebar({ children, className }: SidebarProps) {
    ...
    return [
      {
        ...
        isActive:
          ...
          location.pathname.includes("/resources/projects"),
      },
      {
        label: "Blogs",
        ...
        isActive:
          ...
          location.pathname.includes("/resources/blogs"),
      },
      {
        label: "Account",
  ...
  return (
    <Fragment>
      <div className="w-full  min-h-[89vh] flex bg-default-50/60 ">
        ...
        <div className="bg-background  min-h-full w-16 hidden sm:block lg:hidden">
        ...
        <div
          className={twMerge(
            "h-full flex-1 overflow-y-auto py-3 cscroll",
            className
          )}
        >
          {children}
