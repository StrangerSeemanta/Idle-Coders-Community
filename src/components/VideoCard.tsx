...
function VideoCard({ children, thumbnail, source }: Props) {
    ...
    return (
        <Fragment>
            ...
            <Modal backdrop="blur" isDismissable={false} placement="center" size="xl" className="bg-background/60" isOpen={isOpen} onOpenChange={onOpenChange}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <ModalFooter>
                                ...
                                <Button color="success" radius="full" endContent={
