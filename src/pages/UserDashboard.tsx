                ...
                loading ?
                    ...
                    : currentUser && currentUser.photoURL ? <>
                        < div className='w-full  h-[89vh] flex flex-col sm:flex-row bg-default-50/60 ' >
                            ...
                            < div className='bg-background  h-full w-64 hidden lg:block' >
                                <div className="flex flex-col px-4 py-3 w-full gap-y-[6px]">
                                    ...
                                    <Button
                                        ...
                                        className={twMerge("flex justify-start w-full text-sm items-center py-3.5 px-3 gap-x-3  rounded-md transition  group font-medium", "bg-transparent hover:bg-danger text-foreground-500 hover:text-white")}
                            ...
                            < div className='bg-background px-3 w-full h-fit sm:h-full sm:w-24 flex sm:block lg:hidden' >
                                <div className="flex bg-transparent  sm:flex-col items-center py-3 w-full gap-y-[6px]">
                                    ...
                                    <div className='no-underline cursor-pointer w-full h-full flex items-center justify-end'>
                                        <div
                                            onClick={handleLogOut}
                                            className={twMerge(" w-10/12 flex justify-center items-center flex-col gap-y-1 group hover:text-foreground text-foreground-400 transition  h-fit py-3 rounded-none bg-transparent", "text-default-500 hover:text-danger-300 font-bold")}>
                            ...
                            <Divider className='hidden lg:block bg-default/30' orientation='vertical' />
                            <div className={twMerge('h-full flex-1 px-4 overflow-y-auto py-3 cscroll', className)}>
